...
// Generated by dart2js (CSP), the Dart to JavaScript compiler version: 1.15.0-dev.1.0.
...
(function() {
  ...
  init.precompiled = function($collectedClasses$) {
    ...
    function Atom(_commands, _config, _notifications, _packages, _views, _workspace, obj) {
    ...
    Atom.prototype = $desc;
    Atom.$__fields__ = ["_commands", "_config", "_notifications", "_packages", "_views", "_workspace", "obj"];
    ...
    ListIterator.$__fields__ = ["_iterable", "__internal$_length", "_index", "_current"];
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    _Deserializer: {
      ...
      }, "call$1", "get$deserialize", 2, 0, 0, 10],
    ...
    }, null, null, 14, 0, null, 25, 26, 20, 30, 33, 38, 28],
    ...
    registerPackage_closure: {
      ...
      }, "call$0", null, null, null, 0, 2, null, 3, 27, "call"]
    },
    ...
    Atom: {
      "^": "ProxyHolder;_commands,_config,_notifications,_packages,_views,_workspace,obj",
      Atom$0: function() {
        var t1, t2, t3;
        t1 = this.obj;
    ...
    }, "call$1", "call$0", "plugin__openDartinoSettings$closure", 0, 2, 30, 3, 4],
          ...
          switch ($async$goto) {
            ...
            case 6:
              ...
              if ($async$result === true) {
                t1 = t1._notifications;
                t1.invoke$3("addInfo", "Launched app on device", t1._options$5$buttons$description$detail$dismissable$icon(null, null, null, true, null));
              } else
                ;
            case 1:
              // return
    ...
    DartinoSdk: {
      ...
      compile$1: function(srcPath) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, t1, t2, t3, srcDir, srcName, dstPath, buildScript;
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                t3.invoke$3("addInfo", "Building application...", t3._options$5$buttons$description$detail$dismissable$icon(null, null, srcPath, true, null));
                $async$goto = 3;
    ...
    SodSdk: {
      "^": "Sdk;sdkRootPath",
      compile$1: function(srcPath) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, t1, srcName, dstPath, t2;
        var $async$compile$1 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                t2.invoke$3("addInfo", "Building application...", t2._options$5$buttons$description$detail$dismissable$icon(null, null, dstPath, true, null));
                $async$goto = 3;
      ...
      var $async$sendDeviceCmd = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 4:
              // join
              $async$returnValue = device.send$2(cmd, args);
              // goto return
              $async$goto = 1;
              break;
            case 1:
    ...
    Device: {
      ...
      disconnect$0: function() {
        return this.send$1("exit").then$1(new R.Device_disconnect_closure(this));
      },
      send$2: function(cmd, args) {
    ...
    Future_wait: function(futures, cleanUp, eagerError) {
      ...
      for (t3 = H.setRuntimeTypeInfo(new H.MappedIterator(null, J.get$iterator$ax(futures._iterable), futures._f), [H.getTypeArgumentByIndex(futures, 0), H.getTypeArgumentByIndex(futures, 1)]); t3.moveNext$0();)
        t3._current.then$2$onError(new P.Future_wait_closure(t1, false, cleanUp, result, t1.remaining++), t2);
      t2 = t1.remaining;
      if (t2 === 0) {
    ...
    }, "call$2", "call$1", "async___nullErrorHandler$closure", 2, 2, 7, 3, 1, 2],
    ...
    Future_wait_handleError: {
      "^": "Closure:21;_box_0,eagerError,cleanUp,result",
      ...
      }, null, null, 4, 0, null, 40, 29, "call"]
    },
    Future_wait_closure: {
      "^": "Closure:22;_box_0,eagerError,cleanUp,result,pos",
    ...
    _Future: {
      ...
      }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 7, 3, 1, 2],
    ...
    _StreamIteratorImpl: {
      ...
      }, "_onError$1", "call$2", "call$1", "get$_onError", 2, 2, 24, 3, 1, 2],
      _onDone$0: [function() {
        if (this._state === 2) {
    ...
    _ForwardingStreamSubscription: {
      ...
      _handleError$2: [function(error, stackTrace) {
        this._addError$2(error, stackTrace);
      }, "call$2", "get$_handleError", 4, 0, 25, 1, 2],
    ...
    _SinkTransformerStreamSubscription: {
      ...
      }, "_handleError$1", "call$2", "call$1", "get$_handleError", 2, 2, 26, 3, 1, 2],
      _handleDone$0: [function() {
        var e, s, exception, t1;
        try {
          this._subscription = null;
    ...
    }, "call$1", "convert___defaultToEncodable$closure", 2, 0, 9, 16],
    _JsonMap: {
    ...
    }, null, null, 8, 0, null, 34, 35, 36, 37],
    ...
    }, "call$1", "js___convertToDart$closure", 2, 0, 9, 8],
...
;
  ...
  (function(lazies) {
    ...
    var t1 = new E.Atom(null, null, null, null, null, null, J.$index$asx($.$get$context(), "atom"));
    t1.Atom$0();
    return t1;
  ...
  $ = new Isolate();
  init.metadata = ["e", "error", "stackTrace", null, "_", "result", "s", "data", "o", "value", "x", "each", "invocation", "str", "code", "line", "object", "nb", "sender", "val", "numberOfArguments", "d", "arg", "exitCode", "r", "closure", "isolate", "state", "arg4", "theStackTrace", "arg1", "v", "element", "arg2", "callback", "captureThis", "self", "arguments", "arg3", "errorCallback", "theError", "errorCode"];
  init.types = [{func: 1, args: [,]}, {func: 1}, {func: 1, v: true}, {func: 1, args: [,,]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, v: true, args: [P.String]}, {func: 1, args: [, P.StackTrace]}, {func: 1, v: true, args: [,], opt: [P.StackTrace]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, ret: P.Object, args: [,]}, {func: 1, args: [P.String,,]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, opt: [,]}, {func: 1, args: [E.NotificationButton]}, {func: 1, args: [P.JsObject]}, {func: 1, args: [R.Device]}, {func: 1, args: [P.$int]}, {func: 1, args: [N.LogRecord]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [P.$int,,]}, {func: 1, v: true, args: [,,]}, {func: 1, args: [P.Object]}, {func: 1, args: [,], opt: [,]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, v: true, args: [,], opt: [,]}, {func: 1, args: [P.EventSink]}, {func: 1, args: [P.Symbol,,]}, {func: 1, v: true, args: [{func: 1, v: true, args: [,]}]}, {func: 1, v: true, opt: [,]}];
