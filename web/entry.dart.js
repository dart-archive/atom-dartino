...
// Generated by dart2js (CSP), the Dart to JavaScript compiler version: 1.17.0-dev.2.0.
...
(function() {
  ...
  init.precompiled = function($collectedClasses$) {
    ...
    function _BroadcastStreamController(_state) {
      this._state = _state;
      this.$deferredAction();
    }
    ...
    function _SyncBroadcastStreamController(onListen, onCancel, _state, _firstSubscription, _lastSubscription, _addStreamState, _doneFuture) {
    ...
    function _AsyncBroadcastStreamController(onListen, onCancel, _state, _firstSubscription, _lastSubscription, _addStreamState, _doneFuture) {
      this.onListen = onListen;
      this.onCancel = onCancel;
      this._state = _state;
      this._firstSubscription = _firstSubscription;
    ...
    function _BufferingStreamSubscription(_zone, _state) {
      this._zone = _zone;
      this._state = _state;
      this.$deferredAction();
    }
    ...
    function _HandleErrorStream(_transform, _test, _source) {
      this._transform = _transform;
      this._test = _test;
      this._source = _source;
      this.$deferredAction();
    ...
    _HandleErrorStream.$__fields__ = ["_transform", "_test", "_source"];
    ...
    function ChunkedConverter() {
      this.$deferredAction();
    }
    ChunkedConverter.builtin$cls = "ChunkedConverter";
    if (!("name" in ChunkedConverter))
      ChunkedConverter.name = "ChunkedConverter";
    $desc = $collectedClasses$.ChunkedConverter[1];
    ChunkedConverter.prototype = $desc;
    ChunkedConverter.$__fields__ = [];
    function Codec() {
      this.$deferredAction();
    }
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    }, null, null, 14, 0, null, 24, 37, 15, 16, 17, 18, 19],
    ...
    Atom: {
      ...
      Atom$0: function() {
        ...
        this._views = t3;
        this._workspace = new Y.Workspace(new B.FutureSerializer([], []), t2.$index(t1, "workspace"));
      }
    }
    ...
    _checkSdkInstalled: function(_) {
      var t1, t2, t3, path, t4;
      t1 = {};
      t2 = $.$get$atom();
      t3 = t2._config;
      path = t3.invoke$3("get", "dartino.sdkPath", null);
      path = path == null ? path : J.trim$0$s(path);
      if (path == null || J.get$length$asx(path) === 0) {
        t3 = $.$get$fs();
    ...
    _installPackage_closure: {
      ...
      call$1: [function(result) {
        if (J.$eq$(result.get$exit(), 0))
          return K.promiseToFuture($.$get$atom()._packages.invoke$2("activatePackage", this.name));
        else {
          result.get$stderr();
    ...
    CommandRegistry_add_closure: {
      ...
      call$1: [function(e) {
        ...
        this.callback.call$1(new D.AtomEvent(D._cvt0(e)));
      }, null, null, 2, 0, null, 3, "call"]
    },
    ContextMenuManager: {
      "^": "ProxyHolder;obj"
    ...
    Config: {
      ...
      onDidChange$2: function(keyPath, options) {
        ...
        t1.disposable = this.observe$3(keyPath, options, new T.Config_onDidChange_closure0(controller));
    ...
    Logger: {
      ...
      log$5: function(logLevel, message, error, stackTrace, zone) {
        var e, t, t1, exception, t2, t3, t4, t5, t6, record, target;
        t1 = this.get$level();
        if (J.$ge$n(J.get$value$x(logLevel), J.get$value$x(t1))) {
          ...
          record = new N.LogRecord(logLevel, t1, t2, new P.DateTime(t5, false), t6, t3, t4, zone);
          if ($.hierarchicalLoggingEnabled)
    ...
    Workspace: {
      ...
      open$2$options: function(_, url, options) {
        ...
        completer = H.setRuntimeTypeInfo(new P._AsyncCompleter(H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null])), [null]);
        t2 = t1._operations;
        t2.push(new Y.Workspace_open_closure(this, url, options));
...
;
  ...
  $ = new Isolate();
  init.metadata = [null, "error", "stackTrace", "e", "_", "result", "o", "data", "str", "invocation", "x", "value", "arg", "code", "s", "numberOfArguments", "arg1", "arg2", "arg3", "arg4", "object", "val", "r", "info", "closure", "sender", "errorCode", "element", "state", "xhr", "callback", "captureThis", "self", "arguments", "each", "errorCallback", "nb", "isolate"];
