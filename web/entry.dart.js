...
// Generated by dart2js (CSP), the Dart to JavaScript compiler version: 1.16.0-dev.0.0.
...
(function() {
  ...
  init.precompiled = function($collectedClasses$) {
    ...
    function DartinoDevPackage(_disposables, _registeredMethods, id) {
    ...
    DartinoDevPackage.$__fields__ = ["_disposables", "_registeredMethods", "id"];
    function DartinoDevPackage_activate_closure($this) {
      this.$this = $this;
      this.$deferredAction();
    }
    DartinoDevPackage_activate_closure.builtin$cls = "DartinoDevPackage_activate_closure";
    if (!("name" in DartinoDevPackage_activate_closure))
      DartinoDevPackage_activate_closure.name = "DartinoDevPackage_activate_closure";
    $desc = $collectedClasses$.DartinoDevPackage_activate_closure[1];
    DartinoDevPackage_activate_closure.prototype = $desc;
    DartinoDevPackage_activate_closure.$__fields__ = ["$this"];
    function DartinoDevPackage__setupLogging_closure() {
      this.$deferredAction();
    }
    ...
    DartinoDevPackage__setupLogging_closure.$__fields__ = [];
    function _checkSdkInstalled_closure(_box_0) {
      this._box_0 = _box_0;
      this.$deferredAction();
    }
    _checkSdkInstalled_closure.builtin$cls = "_checkSdkInstalled_closure";
    if (!("name" in _checkSdkInstalled_closure))
      _checkSdkInstalled_closure.name = "_checkSdkInstalled_closure";
    $desc = $collectedClasses$._checkSdkInstalled_closure[1];
    _checkSdkInstalled_closure.prototype = $desc;
    _checkSdkInstalled_closure.$__fields__ = ["_box_0"];
    function _checkSdkInstalled_closure0(_box_0) {
      this._box_0 = _box_0;
      this.$deferredAction();
    }
    _checkSdkInstalled_closure0.builtin$cls = "_checkSdkInstalled_closure0";
    if (!("name" in _checkSdkInstalled_closure0))
      _checkSdkInstalled_closure0.name = "_checkSdkInstalled_closure0";
    $desc = $collectedClasses$._checkSdkInstalled_closure0[1];
    _checkSdkInstalled_closure0.prototype = $desc;
    _checkSdkInstalled_closure0.$__fields__ = ["_box_0"];
    function _checkSdkValid_closure() {
      this.$deferredAction();
    }
    _checkSdkValid_closure.builtin$cls = "_checkSdkValid_closure";
    if (!("name" in _checkSdkValid_closure))
      _checkSdkValid_closure.name = "_checkSdkValid_closure";
    $desc = $collectedClasses$._checkSdkValid_closure[1];
    _checkSdkValid_closure.prototype = $desc;
    _checkSdkValid_closure.$__fields__ = [];
    ...
    Symbol.$__fields__ = [];
    function Uri(scheme, _userInfo, _host, _port, _path, _query, _fragment, _pathSegments, _queryParameters, _queryParameterLists) {
      this.scheme = scheme;
    ...
    Uri.prototype = $desc;
    Uri.$__fields__ = ["scheme", "_userInfo", "_host", "_port", "_path", "_query", "_fragment", "_pathSegments", "_queryParameters", "_queryParameterLists"];
    ...
    MidiPort.prototype.get$state = function(receiver) {
    ...
    function Disposables(catchExceptions, _disposable$_disposables) {
      this.catchExceptions = catchExceptions;
      this._disposable$_disposables = _disposable$_disposables;
      this.$deferredAction();
    }
    ...
    Disposables.$__fields__ = ["catchExceptions", "_disposable$_disposables"];
    function DisposeableSubscription(sub) {
      this.sub = sub;
      this.$deferredAction();
    }
    DisposeableSubscription.builtin$cls = "DisposeableSubscription";
    if (!("name" in DisposeableSubscription))
      DisposeableSubscription.name = "DisposeableSubscription";
    $desc = $collectedClasses$.DisposeableSubscription[1];
    DisposeableSubscription.prototype = $desc;
    DisposeableSubscription.$__fields__ = ["sub"];
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    Interceptor: {
      ...
      }, null, "get$noSuchMethod", 2, 0, null, 13],
    ...
    }, null, null, 14, 0, null, 20, 22, 24, 28, 32, 35, 42],
    ...
    Primitives_functionNoSuchMethod_closure: {
      "^": "Closure:37;_box_0,$arguments,namedArgumentList",
    ...
    registerPackage_closure: {
      ...
      }, "call$0", null, null, null, 0, 2, null, 2, 19, "call"]
    },
    registerPackage_closure0: {
      ...
      call$0: [function() {
        ...
        try {
          ...
          t1.toString;
          R.disconnectDevices();
          $.$get$_logger0().info$1("deactivated");
          t1._disposables.dispose$0();
        } catch (exception) {
          t1 = H.unwrapException(exception);
          e = t1;
          st = H.getTraceFromException(exception);
    ...
    Config: {
      ...
      onDidChange$2: function(keyPath, options) {
        ...
        t1 = {};
        t1.disposable = null;
        controller = P.StreamController_StreamController$broadcast(new E.Config_onDidChange_closure(t1), null, false, null);
        t1.disposable = this.observe$3(keyPath, options, new E.Config_onDidChange_closure0(controller));
        return H.setRuntimeTypeInfo(new P._BroadcastStream(controller), [H.getTypeArgumentByIndex(controller, 0)]);
      },
      onDidChange$1: function(keyPath) {
    ...
    }, "call$1", "call$0", "plugin__openDartinoSettings$closure", 0, 2, 12, 2, 1],
    _checkSdkInstalled: function(_) {
      var t1, t2, path, t3;
      t1 = {};
      t2 = $.$get$atom();
      path = t2._config.getValue$1("dartino.sdkPath");
      if (path == null || J.trim$0$s(path).length === 0) {
        path = t2._config.getValue$1("dartino.dartinoPath");
        if (path == null || J.trim$0$s(path).length === 0)
          path = t2._config.getValue$1("dartino.sodPath");
        if (path != null && J.trim$0$s(path).length !== 0) {
          t2._config.invoke$3("set", "dartino.sdkPath", path);
          t2._config.invoke$3("set", "dartino.dartinoPath", null);
          t2._config.invoke$3("set", "dartino.sodPath", null);
          return;
        }
      }
      if (path == null || J.trim$0$s(path).length === 0) {
        t3 = $.$get$fs();
        path = t3.join$2(0, t3._os.callMethod$1("homedir"), "dartino-sdk");
        if (t3.invoke$2("existsSync", path) === true)
          t2._config.invoke$3("set", "dartino.sdkPath", path);
        else
          path = null;
      }
      ...
      t1.info = new D.Notification(t2.invoke$3("addInfo", "Install Dartino SDK?", t2._options$5$buttons$description$detail$dismissable$icon([new D.NotificationButton("Install SDK", new U._checkSdkInstalled_closure(t1)), new D.NotificationButton("Open Settings", new U._checkSdkInstalled_closure0(t1))], null, "No Dartino SDK has been configured.\n \nWould you like the Dartino SDK\nautomatically downloaded and installed?\n \nOr would you like to open the settings page and specify\nthe location of an already installed Dartino SDK?", true, null)));
    },
    _checkSdkValid: [function(_) {
      var t1 = $._skipSdkCheck;
      if (t1 > 0) {
        $._skipSdkCheck = t1 - 1;
        return;
      }
      ...
      if (t1 == null)
        ...
        t1.cancel$0();
      $._checkSdkTimer = P.Timer_Timer($.$get$_checkSdkTimeout(), new U._checkSdkValid_closure());
    }, function() {
      return U._checkSdkValid(null);
    }, "call$1", "call$0", "plugin___checkSdkValid$closure", 0, 2, 12, 2, 1],
    _dispatch: function(commandName) {
      var t1, view;
      t1 = $.$get$atom();
      view = t1._views.invoke$2("getView", t1._workspace);
      t1._commands.invoke$4("dispatch", view, commandName, null);
    },
    ...
    DartinoDevPackage: {
      "^": "AtomPackage;_disposables,_registeredMethods,id",
      activate$1: function(state) {
        var t1, t2;
        this._setupLogging$0();
        t1 = $.$get$_logger0();
        t1.info$1("activated");
        t1.fine$1("Running on Chrome version " + H.S(J.$index$asx(J.$index$asx($.$get$process().obj, "versions"), "chrome")) + ".");
        P.Future_Future$delayed(C.Duration_0, new U.DartinoDevPackage_activate_closure(this), null);
        t1 = $.$get$atom();
        t2 = this._disposables._disposable$_disposables;
        t2.push(t1._commands.add$3(0, "atom-workspace", "dartino:settings", U.plugin__openDartinoSettings$closure()));
        t2.push(t1._commands.add$3(0, "atom-workspace", "dartino:run-app-on-device", U.plugin___runAppOnDevice$closure()));
        t2.push(t1._commands.add$3(0, "atom-workspace", "dartino:getting-started", U.plugin___showGettingStarted$closure()));
        t2.push(t1._commands.add$3(0, "atom-workspace", "dartino:sdk-docs", U.plugin___showSdkDocs$closure()));
      },
      _setupLogging$0: function() {
        this._disposables._disposable$_disposables.push($.$get$atom()._config.observe$3("dartino.logging", null, new U.DartinoDevPackage__setupLogging_closure()));
      }
    },
    DartinoDevPackage_activate_closure: {
      "^": "Closure:26;$this",
      call$0: function() {
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                $async$goto = 2;
                return P._asyncHelper(Q.install("Dartino", $async$self.$this, false), $async$call$0, $async$completer);
              case 2:
                // returning from await.
                U._checkSdkInstalled(null);
                // implicit return
    ...
    DartinoDevPackage__setupLogging_closure: {
      ...
      call$1: [function(val) {
        ...
        $.$get$_logger0().info$1("logging level: " + H.S($.$get$Logger_root().get$level()));
      }, null, null, 2, 0, null, 21, "call"]
    },
    _checkSdkInstalled_closure: {
      "^": "Closure:1;_box_0",
      call$0: [function() {
        this._box_0.info.invoke$1("dismiss");
        U._dispatch("dartino:install-sdk");
      }, null, null, 0, 0, null, "call"]
    },
    _checkSdkInstalled_closure0: {
      "^": "Closure:1;_box_0",
      call$0: [function() {
        this._box_0.info.invoke$1("dismiss");
        $.$get$atom()._workspace.open$1(0, "atom://config/packages/dartino");
    ...
    _checkSdkValid_closure: {
      "^": "Closure:1;",
      call$0: function() {
        U._dispatch("dartino:validate-sdk");
      }
    },
    ...
    findSdk: function(srcPath) {
      var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, sdk, t1;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              if (sdk == null) {
                t1 = $.$get$atom()._notifications;
                t1.invoke$3("addError", "No SOD or Dartino path specified.", t1._options$5$buttons$description$detail$dismissable$icon([new D.NotificationButton("Open settings", U.plugin__openDartinoSettings$closure())], null, "Please download SOD or Dartino and set the path in\nSettings > Packages > dartino > SOD root directory.\nSee Dartino settings for more information.", true, null));
                // goto return
                $async$goto = 1;
                break;
              } else
    ...
    rawDartinoSdk: function() {
      var path = $.$get$atom()._config.getValue$1("dartino.dartinoPath");
      if (path == null)
        return;
      path = J.trim$0$s(path);
      if (path.length === 0)
        return;
      return new R.DartinoSdk(path);
    },
    rawSodSdk: function() {
      var path = $.$get$atom()._config.getValue$1("dartino.sodPath");
      if (path == null)
        return;
      path = J.trim$0$s(path);
      if (path.length === 0)
        return;
      return new T.SodSdk(path);
    },
    Sdk: {
      "^": "Object;sdkRootPath<"
    }
    ...
    DartinoSdk: {
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                H.checkString(t2);
                buildScript = $async$self.sdkRootPath + H.stringReplaceAllUnchecked("/platforms/stm32f746g-discovery/bin/build.sh", "/", t2);
                t2 = $.$get$atom();
      ...
      verifyInstall$1$suggestion: function(suggestion) {
        ...
        var $async$verifyInstall$1$suggestion = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          }
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                if (!F.checkSdkFile("Dartino", t1, ["platforms/stm32f746g-discovery/bin/build.sh"], "Please download the SDK and set the Dartino SDK path in\nSettings > Packages > dartino > Dartino root directory")) {
                  $async$returnValue = false;
                  // goto return
                  $async$goto = 1;
                  break;
                ...
                t2.invoke$3("addInfo", "Downloading additional Dartino tools...", t2._options$5$buttons$description$detail$dismissable$icon(null, null, "into " + t1, true, null));
                $async$goto = 3;
                return P._asyncHelper(Z.runProc("bin/dartino", ["x-download-tools"], t1, "", "download additional Dartino tools"), $async$verifyInstall$1$suggestion, $async$completer);
              case 3:
                // returning from await.
                $async$returnValue = $async$result != null;
                // goto return
        ...
        return P._asyncHelper(null, $async$verifyInstall$1$suggestion, $async$completer, null);
      },
      verifyInstall$0: function() {
        return this.verifyInstall$1$suggestion(null);
      }
    }
          ...
          while (true)
            switch ($async$goto) {
              ...
              case 3:
                // returning from await.
                stdout = $async$result;
                new D.Notification(t2).invoke$1("dismiss");
                if (stdout == null) {
                  // goto return
                  $async$goto = 1;
                  break;
    ...
    checkSdkFile: function(sdkName, sdkPath, relPaths, suggestion) {
      ...
      for (t1 = relPaths.length, _i = 0; _i < relPaths.length; relPaths.length === t1 || (0, H.throwConcurrentModificationError)(relPaths), ++_i) {
        ...
        if (t2.invoke$2("existsSync", t2.join$2(0, sdkPath, relPath)) !== true) {
          t1 = $.$get$atom()._notifications;
          t1.invoke$3("addError", "Invalid " + sdkName + " directory specified.", t1._options$5$buttons$description$detail$dismissable$icon([new D.NotificationButton("Open settings", U.plugin__openDartinoSettings$closure())], null, 'Could not find "' + relPath + '" in\n' + sdkPath + ".\n" + suggestion, null, null));
          return false;
        }
      }
      return true;
    ...
    Device: {
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                $async$self._stderrSubscription = new P.LineSplitter().super$Converter$bind(H.setRuntimeTypeInfo(new P._ControllerStream(t2), [H.getTypeArgumentByIndex(t2, 0)])).listen$1($async$self.get$_processStderr());
                t2 = $async$self._runner._stdoutController;
                $async$self._stdoutSubcription = new P.LineSplitter().super$Converter$bind(H.setRuntimeTypeInfo(new P._ControllerStream(t2), [H.getTypeArgumentByIndex(t2, 0)])).listen$1($async$self.get$_processStdout());
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                t2._contents = "";
                $async$goto = 3;
                return P._asyncHelper(t1.future.timeout$1(0, $.$get$_timeout()).catchError$2$test(new R.Device__nextResult_closure($async$self), new R.Device__nextResult_closure0()), $async$_nextResult$0, $async$completer);
              case 3:
                // returning from await.
                line = $async$result;
                if (line == null) {
      ...
      }, "call$1", "get$_processStderr", 2, 0, 6, 11],
      ...
      }, "call$1", "get$_processStdout", 2, 0, 6, 11]
    },
    Device_connect_closure: {
      "^": "Closure:39;$this",
      call$1: [function(exitCode) {
        var t1 = this.$this;
        $.$get$_logger2().fine$1("Device disconnected [" + H.S(exitCode) + "]: " + H.S(t1.ttyPath));
        t1._runner = null;
        t1._cleanup$0();
    ...
    main: [function() {
      ...
      E.registerPackage(new U.DartinoDevPackage(new L.Disposables(true, []), P.LinkedHashMap__makeEmpty(), "dartino"));
  ...
  }, 1], ["atom.utils.package_deps", "package:atom/utils/package_deps.dart",, Q, {
    "^": "",
    ...
    }, "call$1", "package_deps___installPackage$closure", 2, 0, 38],
    install_closure: {
      "^": "Closure:15;packageLabel,justNotify",
    ...
    Future_forEach: function(input, f) {
      var iterator = new P._LinkedHashSetIterator(input, input._collection$_modifications, null, null);
      iterator._collection$_cell = input._collection$_first;
    ...
    }, "call$2", "call$1", "async___nullErrorHandler$closure", 2, 2, 9, 2, 3, 4],
    ...
    Future_doWhile_closure: {
      "^": "Closure:22;_box_0,f,doneSignal",
    ...
    _Completer: {
      ...
      }, "completeError$1", "call$2", "call$1", "get$completeError", 2, 2, 8, 2, 3, 4]
    },
    _AsyncCompleter: {
      "^": "_Completer;future",
    ...
    _Future: {
      ...
      }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 9, 2, 3, 4],
    ...
    _Future__chainForeignFuture_closure0: {
      ...
      }, "call$1", null, null, null, 2, 2, null, 2, 3, 4, "call"]
    },
    _Future__chainForeignFuture_closure1: {
    ...
    _StreamIteratorImpl: {
      ...
      }, "_onError$1", "call$2", "call$1", "get$_onError", 2, 2, 8, 2, 3, 4],
      _onDone$0: [function() {
        if (this._state === 2) {
    ...
    _ForwardingStreamSubscription: {
      ...
      _handleError$2: [function(error, stackTrace) {
        this._addError$2(error, stackTrace);
      }, "call$2", "get$_handleError", 4, 0, 40, 3, 4],
    ...
    _SinkTransformerStreamSubscription: {
      ...
      }, "_handleError$1", "call$2", "call$1", "get$_handleError", 2, 2, 27, 2, 3, 4],
      _handleDone$0: [function() {
        var e, s, exception, t1;
        try {
          this._subscription = null;
    ...
    }, "call$1", "convert___defaultToEncodable$closure", 2, 0, 10, 14],
    _JsonMap: {
    ...
    EventTarget: {
      ...
      "%": "CrossOriginServiceWorkerClient|MediaStream;EventTarget;EventTarget_ListMixin|EventTarget_ListMixin_ImmutableListMixin|EventTarget_ListMixin0|EventTarget_ListMixin_ImmutableListMixin0"
    },
    FieldSetElement: {
      "^": "HtmlElement;name=",
      "%": "HTMLFieldSetElement"
    ...
    }, "call$1", "js___convertToDart$closure", 2, 0, 10, 9],
    ...
    Disposables: {
      "^": "Object;catchExceptions,_disposable$_disposables",
      add$1: function(_, disposable) {
        return this._disposable$_disposables.push(disposable);
      },
      dispose$0: [function() {
        var disposable, e, st, t1, t2, _i, exception, t3;
        for (t1 = this._disposable$_disposables, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
          disposable = t1[_i];
          try {
    ...
    ProcessRunner: {
      ...
      execStreaming$0: function() {
        ...
        t4 = this.cwd;
        t1.fine$1(t3 + (t4 == null ? "" : " (cwd=" + H.S(t4) + ")"));
        try {
          this._process = E.BufferedProcess_create(t2, this.args, t4, this.env, new X.ProcessRunner_execStreaming_closure(this), new X.ProcessRunner_execStreaming_closure0(this), new X.ProcessRunner_execStreaming_closure1(this), new X.ProcessRunner_execStreaming_closure2(this));
        } catch (exception) {
          t1 = H.unwrapException(exception);
          e = t1;
    ...
    NotificationManager: {
      ...
      _options$5$buttons$description$detail$dismissable$icon: function(buttons, description, detail, dismissable, icon) {
        ...
        if (buttons != null)
          m.$indexSet(0, "buttons", K.jsify(H.setRuntimeTypeInfo(new H.MappedListIterable(buttons, new D.NotificationManager__options_closure()), [null, null]).toList$0(0)));
        return m;
      }
    },
    NotificationManager__options_closure: {
...
;
  ...
  (function(lazies) {
    ...
    t1.Atom$0();
    return t1;
  }, "atom", "_logger0", "$get$_logger0", function() {
    return N.Logger_Logger("dartino");
  }, "_logger0", "_checkSdkTimeout", "$get$_checkSdkTimeout", function() {
    return P.Duration$(0, 0, 0, 0, 0, 3);
  }, "_checkSdkTimeout", "_devices", "$get$_devices", function() {
    return P.LinkedHashMap__makeEmpty();
  }, "_devices", "_logger2", "$get$_logger2", function() {
    return N.Logger_Logger("dartino/usb");
  }, "_logger2", "_timeout", "$get$_timeout", function() {
    return P.Duration$(0, 0, 0, 0, 0, 4);
  }, "_timeout", "_AsyncRun__scheduleImmediateClosure", "$get$_AsyncRun__scheduleImmediateClosure", function() {
  ...
  }, "isLinux", "_logger1", "$get$_logger1", function() {
  ...
  $ = new Isolate();
  init.metadata = ["e", "_", null, "error", "stackTrace", "result", "s", "value", "data", "o", "str", "line", "each", "invocation", "object", "x", "arg", "code", "sender", "state", "closure", "val", "isolate", "d", "numberOfArguments", "exitCode", "r", "info", "arg1", "errorCode", "nb", "theStackTrace", "arg2", "v", "element", "arg3", "byteString", "xhr", "callback", "captureThis", "self", "arguments", "arg4", "errorCallback", "theError"];
  init.types = [{func: 1, args: [,]}, {func: 1}, {func: 1, v: true}, {func: 1, args: [,,]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, args: [P.String]}, {func: 1, v: true, args: [P.String]}, {func: 1, args: [, P.StackTrace]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, v: true, args: [,], opt: [P.StackTrace]}, {func: 1, ret: P.Object, args: [,]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, v: true, opt: [,]}, {func: 1, args: [N.LogRecord]}, {func: 1, opt: [,]}, {func: 1, args: [P.Map]}, {func: 1, args: [X.ProcessResult]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.$int,,]}, {func: 1, v: true, args: [,,]}, {func: 1, args: [P.Object]}, {func: 1, args: [P.bool]}, {func: 1, ret: P.bool}, {func: 1, args: [P.JsObject]}, {func: 1, args: [,], opt: [,]}, {func: 1, ret: P.Future}, {func: 1, v: true, args: [,], opt: [,]}, {func: 1, args: [P.EventSink]}, {func: 1, args: [P.Symbol,,]}, {func: 1, args: [R.Device]}, {func: 1, ret: P.$int, args: [,,]}, {func: 1, v: true, args: [P.String], opt: [,]}, {func: 1, ret: P.$int, args: [P.$int, P.$int]}, {func: 1, args: [W.HttpRequest]}, {func: 1, v: true, args: [{func: 1, v: true, args: [,]}]}, {func: 1, args: [D.NotificationButton]}, {func: 1, args: [P.String,,]}, {func: 1, ret: P.Future, args: [P.String]}, {func: 1, args: [P.$int]}, {func: 1, v: true, args: [, P.StackTrace]}];
