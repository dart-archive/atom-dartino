...
// Generated by dart2js (CSP), the Dart to JavaScript compiler version: 1.16.0-dev.1.0.
...
(function() {
  ...
  init.precompiled = function($collectedClasses$) {
    ...
    function Atom(_commands, _config, _grammars, _notifications, _packages, _project, _views, _workspace, obj) {
    ...
    Atom.prototype = $desc;
    Atom.$__fields__ = ["_commands", "_config", "_grammars", "_notifications", "_packages", "_project", "_views", "_workspace", "obj"];
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    Interceptor: {
      ...
      }, null, "get$noSuchMethod", 2, 0, null, 9],
      "%": "MediaError|MediaKeyError|PushMessageData|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString"
    },
    JSBool: {
      "^": "Interceptor;",
    ...
    }, null, null, 14, 0, null, 25, 37, 15, 16, 17, 18, 19],
    ...
    Atom: {
      "^": "ProxyHolder;_commands,_config,_grammars,_notifications,_packages,_project,_views,_workspace,obj",
      Atom$0: function() {
        var t1, t2, t3;
        t1 = this.obj;
        ...
        this._grammars = new E.GrammarRegistry(E._cvt(t2.$index(t1, "grammars")));
    ...
    TextEditor: {
      ...
      $eq: function(_, other) {
        if (other == null)
          return false;
        return other instanceof E.TextEditor && J.$eq$(this.obj, other.obj);
      }
    },
    GrammarRegistry: {
      "^": "ProxyHolder;obj"
    ...
    }, "call$1", "call$0", "plugin__openDartinoSettings$closure", 0, 2, 10, 0],
    _checkSdkInstalled: function(_) {
      var t1, t2, path, t3, t4;
      t1 = {};
      t2 = $.$get$atom();
      ...
      if (path == null || J.trim$0$s(path).length === 0) {
        t3 = $.$get$fs();
        t4 = t3._os.callMethod$1("homedir");
        t3.toString;
        path = H.S(t4) + t3.separator + "dartino-sdk";
    ...
    }, "call$1", "call$0", "plugin___checkSdkValid$closure", 0, 2, 10, 0, 4],
    ...
    main: [function() {
      ...
      L.registerPackage(new U.DartinoDevPackage(new L.Disposables(true, []), P.LinkedHashMap__makeEmpty(), "dartino"));
    ...
    }, "call$1", "package_deps___installPackage$closure", 2, 0, 28],
    install_closure: {
    ...
    }, "call$2", "call$1", "async___nullErrorHandler$closure", 2, 2, 7, 0, 1, 2],
    ...
    Future_doWhile_closure: {
      "^": "Closure:19;_box_0,f,doneSignal",
    ...
    _Completer: {
      ...
      }, "completeError$1", "call$2", "call$1", "get$completeError", 2, 2, 6, 0, 1, 2]
    },
    _AsyncCompleter: {
      "^": "_Completer;future",
    ...
    _Future: {
      ...
      }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 7, 0, 1, 2],
    ...
    _StreamIteratorImpl: {
      ...
      }, "_onError$1", "call$2", "call$1", "get$_onError", 2, 2, 6, 0, 1, 2],
      _onDone$0: [function() {
        if (this._state === 2) {
    ...
    _ForwardingStreamSubscription: {
      ...
      }, "call$2", "get$_handleError", 4, 0, 21, 1, 2],
    ...
    }, "call$1", "js___convertToDart$closure", 2, 0, 29, 6],
    ...
    ProcessRunner: {
      ...
      execStreaming$0: function() {
        ...
        t1.fine$1(t3);
        try {
          this._process = X.BufferedProcess_create(t2, this.args, this.cwd, this.env, new X.ProcessRunner_execStreaming_closure(this), new X.ProcessRunner_execStreaming_closure0(this), new X.ProcessRunner_execStreaming_closure1(this), new X.ProcessRunner_execStreaming_closure2(this));
        } catch (exception) {
          t1 = H.unwrapException(exception);
          e = t1;
    ...
    registerPackage_closure: {
      ...
      }, "call$0", null, null, null, 0, 2, null, 0, 28, "call"]
    },
    ...
    AtomPackage: {
      ...
      loadPackageJson$0: function() {
        return H.subtypeCast(W.HttpRequest_getString("atom://" + this.id + "/package.json", null, null).then$1(new L.AtomPackage_loadPackageJson_closure()), "$isFuture", [[P.Map, P.String,,]], "$asFuture");
      }
    },
...
;
  ...
  (function(lazies) {
    ...
    var t1 = new E.Atom(null, null, null, null, null, null, null, null, J.$index$asx($.$get$context(), "atom"));
    t1.Atom$0();
    return t1;
  ...
  }, "_checkSdkTimeout", "_AsyncRun__scheduleImmediateClosure", "$get$_AsyncRun__scheduleImmediateClosure", function() {
  ...
  }, "isWindows", "_logger1", "$get$_logger1", function() {
  ...
  $ = new Isolate();
  init.metadata = [null, "error", "stackTrace", "e", "_", "result", "o", "data", "str", "invocation", "x", "value", "arg", "code", "s", "numberOfArguments", "arg1", "arg2", "arg3", "arg4", "sender", "object", "val", "r", "info", "closure", "errorCode", "element", "state", "xhr", "callback", "captureThis", "self", "arguments", "each", "errorCallback", "nb", "isolate"];
  init.types = [{func: 1, args: [,]}, {func: 1}, {func: 1, v: true}, {func: 1, args: [P.String]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, args: [, P.StackTrace]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, v: true, args: [,], opt: [P.StackTrace]}, {func: 1, args: [,,]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, v: true, opt: [,]}, {func: 1, args: [P.String,,]}, {func: 1, args: [, P.String]}, {func: 1, ret: P.Future}, {func: 1, args: [N.LogRecord]}, {func: 1, args: [P.Map]}, {func: 1, args: [X.ProcessResult]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [P.$int,,]}, {func: 1, args: [P.bool]}, {func: 1, args: [,], opt: [,]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, args: [P.Symbol,,]}, {func: 1, args: [W.HttpRequest]}, {func: 1, v: true, args: [{func: 1, v: true, args: [,]}]}, {func: 1, args: [P.JsObject]}, {func: 1, args: [D.NotificationButton]}, {func: 1, opt: [,]}, {func: 1, ret: P.Future, args: [P.String]}, {func: 1, ret: P.Object, args: [,]}];
